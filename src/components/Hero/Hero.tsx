...
export const Hero: React.FC<HeroProps> = ({
  ...
  return (
    ...
    >
      ...
      <motion.div
        initial={isReturningVisit ? false : { opacity: 0 }}
      ...
      <motion.div
        initial={isReturningVisit ? false : { opacity: 0, scaleY: 0 }}
      ...
      />
      <motion.div
        initial={isReturningVisit ? false : { opacity: 0, y: 16 }}
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full flex-grow flex flex-col justify-center items-center py-6">
        <div className="relative text-center w-full max-w-4xl flex flex-col items-center">
          ...
          <motion.div
            initial={isReturningVisit ? false : { opacity: 0, scale: 0.85 }}
          ...
          <div className="relative w-full flex flex-col items-center overflow-visible">
            <motion.h1
              initial={isReturningVisit ? false : { opacity: 0, y: 0, filter: 'blur(6px)' }}
          ...
          <motion.div
            initial={isReturningVisit ? false : { opacity: 0, y: 25 }}
          ...
          >
            ...
            <motion.div
              initial={isReturningVisit ? false : { opacity: 0, y: 15 }}
        ...
        <motion.div
          initial={isReturningVisit ? false : { opacity: 0, y: 35, scale: 0.96 }}
