...
export const Hero: React.FC<HeroProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="hidden xl:flex absolute left-12 top-1/2 -translate-y-1/2 flex-col justify-between h-[380px] pl-4 pointer-events-none z-10">
        <div
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full flex-grow flex flex-col justify-center items-center py-6">
        <div className="relative text-center w-full max-w-4xl flex flex-col items-center">
          ...
          <div className="mt-8 sm:mt-10 max-w-md text-center mx-auto space-y-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-1">
              <button
                ...
                className="inline-flex items-center gap-3 bg-[#3D2B1F] hover:bg-[#3D2B1F]/85 text-[#FDFCFB] px-8 py-3.5 rounded-full text-[10px] uppercase tracking-[0.3em] font-medium transition-all duration-300 shadow-md group"
              ...
              <button
                ...
                className="inline-flex items-center space-x-3 text-[#3D2B1F] hover:opacity-60 transition-opacity py-2 px-4"
              >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto pt-8 border-t border-[#3D2B1F]/10 grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 items-end gap-6 text-[#3D2B1F]">
